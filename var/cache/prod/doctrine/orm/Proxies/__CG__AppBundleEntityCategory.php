...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'adminId', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'teachers', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'posts'];
        }
