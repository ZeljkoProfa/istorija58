...
class Video extends \AppBundle\Entity\Video implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Video' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Video' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Video' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\Video' . "\0" . 'path', '' . "\0" . 'AppBundle\\Entity\\Video' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Video' . "\0" . 'status'];
        }
